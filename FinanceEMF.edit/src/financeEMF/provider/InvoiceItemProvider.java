...
/**
 * This is the item provider adapter for a {@link financeEMF.Invoice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InvoiceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Invoice_invoice_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Invoice_invoice_id_feature", "_UI_Invoice_type"),
				 FinanceEMFPackage.Literals.INVOICE__INVOICE_ID,
				 true,
				 false,
				 false,
	...
	protected void addGroup_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Invoice_group_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Invoice_group_id_feature", "_UI_Invoice_type"),
				 FinanceEMFPackage.Literals.INVOICE__GROUP_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Invoice.class)) {
			case FinanceEMFPackage.INVOICE__INVOICE_ID:
			case FinanceEMFPackage.INVOICE__GROUP_ID:
